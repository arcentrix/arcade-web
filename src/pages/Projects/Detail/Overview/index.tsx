...
import { CheckCircle2, XCircle, Clock, Play, GitBranch, Users, Globe, Rocket } from 'lucide-react'
  ...
  return (
    <div className="space-y-6">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Pipeline execution statistics for this project</CardDescription>
        </CardHeader>
        <CardContent>
          {loading ? (
              ...
              <div className="rounded-lg border bg-card p-6 hover:shadow-md transition-shadow">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-3xl font-bold mt-2">{pipelineStats.total}</p>
                  </div>
              ...
              <div className="rounded-lg border bg-card p-6 hover:shadow-md transition-shadow border-green-200 bg-green-50/30">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-3xl font-bold mt-2 text-green-700">{pipelineStats.success}</p>
              ...
              <div className="rounded-lg border bg-card p-6 hover:shadow-md transition-shadow border-red-200 bg-red-50/30">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-3xl font-bold mt-2 text-red-700">{pipelineStats.failure}</p>
                    <p className="text-xs text-muted-foreground mt-1">
                      {pipelineStats.total > 0 
              ...
              <div className="rounded-lg border bg-card p-6 hover:shadow-md transition-shadow border-blue-200 bg-blue-50/30">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-3xl font-bold mt-2 text-blue-700">{pipelineStats.running}</p>
    ...
    <Card>
      <CardHeader>
        ...
        <CardDescription>Overview of project {projectId} information and statistics</CardDescription>
      </CardHeader>
      <CardContent>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
