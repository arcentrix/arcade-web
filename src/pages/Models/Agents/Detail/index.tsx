...
import { Zap, Edit, Power, PowerOff } from 'lucide-react'
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-muted-foreground mt-1">
              Agent ID: <code className="text-xs bg-muted px-2 py-1 rounded">{agent.agentId}</code>
            </p>
          </div>
              ...
              <CardContent className="space-y-4">
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">{agent.arch}</p>
                  </div>
                  <div>
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">{agent.metrics}</p>
                  </div>
                </div>
