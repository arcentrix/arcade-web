...
import { History, Clock, CheckCircle2, XCircle, Loader2, Filter, RefreshCw } from 'lucide-react'
...
type PipelineExecutionStatus = 'success' | 'failed' | 'running' | 'cancelled' | 'pending'
...
const PipelineHistory: FC = () => {
  ...
  const filteredExecutions = useMemo(() => {
    return executions.filter((execution) => {
      const matchesSearch =
        execution.pipelineName.toLowerCase().includes(searchText.toLowerCase()) ||
            ...
            return (
              ...
              >
                <CardContent className="p-3 px-4 space-y-1.5">
                  ...
                  <div className="flex items-center justify-between" style={{ lineHeight: '20px' }}>
